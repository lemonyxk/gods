...
func assertIteratorImplementation[T comparable, P comparable]() {
	var _ containers.ReverseIteratorWithKey[T, P] = (*Iterator[T, P])(nil)
}

// Iterator holding the iterator's state
type Iterator[T comparable, P comparable] struct {
	iterator rbt.Iterator[T, P]
}

// Iterator returns a stateful iterator whose elements are key/value pairs.
func (m *Map[T, P]) Iterator() Iterator[T, P] {
	return Iterator[T, P]{iterator: m.forwardMap.Iterator()}
}
